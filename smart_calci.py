responses=["SMART CALCULATOR","TEXT BASED CALCULATOR",
...
operations={"PLUS":add,"ADD":add,"ADDITION":add,"SUM":add,"+":add,
	"MINUS":sub,"SUBTRACTION":sub,"SUBTRACT":sub,
	"DIFFERENCE":sub,"-":sub, "PRODUCT":multiply,
    "MULTIPLICATION":multiply,"MULTIPLY":multiply,"*":multiply,
	"DIVIDE":division,"DIVISION":division,"/":division, "LCM":lcm,"HCF":hcf,
	"BIG":big,"MAX":big,"GREATER":big
            }
commands={"NAME":myname,"END":end,"EXIT":end,"CLOSE":end,"HELP":help}

#  MAIN FUNTION (FOR INPUT AND EXCEPTIONS )
def main():
    print(responses[0])
    print(responses[1])
    while True:
